...
| 2 | **1st tap** on “I'm following✅” | If `pending_dm_content` exists and `reminder_sent_count < 1`: send same CTA (Visit profile + I'm following), set `reminder_sent_count = 1`, return. |
